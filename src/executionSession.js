...
export class ExecutionSession {
  ...
  composePrompt(context) {
    return composePrompt([
      ...
      '- {"action":"finish","summary":"...","rationale":"Intent: ... | Trade-offs: ... | Evidence: ... | Next step: ...","prTitle":"optional","prBody":"optional"}',
      "Rules:",
      "- Return JSON only.",
      ...
      "- For finish.rationale, include: Intent, Trade-offs, Evidence, and Next step.",
